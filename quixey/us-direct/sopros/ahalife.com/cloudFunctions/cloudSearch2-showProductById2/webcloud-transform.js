  ...
  var transform = {
    "func://ahalife.com/cloudSearch2-showProductById2": function(webcloudOutput) {
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        var output = {
          "displayContent": {          
          "description": getNodeValue(["//div[contains(@class, 'product-info')]/div[contains(@class, 'description')]/div[contains(@class, 'info-content')]/p"], doc),
          "image": getNodeValue(["//ul[contains(@class, 'carousel_large')]/li[contains(@class, 'collectible')]/a[contains(@class, 'zoomImage')]/img"], doc),
          "manufacturer": getNodeValue(["//a[contains(@class, 'highlight')]"], doc),
          "name": getNodeValue(["//h1[contains(@class, 'heading1')]"], doc),
          "price": getNodeValue(["//div[contains(@class, 'sku-price')]"], doc),
