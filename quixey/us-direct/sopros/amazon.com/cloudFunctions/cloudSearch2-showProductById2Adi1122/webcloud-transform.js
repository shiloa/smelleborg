  ...
  var transform = {
    "func://amazon.com/cloudSearch2-showProductById2Adi1122": function(webcloudOutput) {
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        addComputedValue(output.displayContent, "rating", ["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-row a-spacing-none a-size-small a-color-secondary')]"], parsers, doc);
