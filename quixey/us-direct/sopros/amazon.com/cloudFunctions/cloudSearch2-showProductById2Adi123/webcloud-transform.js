  ...
  var transform = {
    "func://amazon.com/cloudSearch2-showProductById2Adi123": function(webcloudOutput) {
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        addComputedValue(output.displayContent, "description", ["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-section a-spacing-micro')]"], parsers, doc);
        addComputedValue(output.displayContent, "expires", ["//span[contains(@class, 'a-color-link')]"], parsers, doc);
