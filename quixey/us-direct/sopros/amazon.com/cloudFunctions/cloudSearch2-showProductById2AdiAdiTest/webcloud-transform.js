  ...
  var transform = {
    "func://amazon.com/cloudSearch2-showProductById2AdiAdiTest": function(cloudOutput) {
      ...
      for (var i = 0; i < cloudOutput.length ; i++) {
        ...
        addComputedValue(output.displayContent, "place_distance", ["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-section a-spacing-micro')]/div[contains(@class, 'a-row')]/span[contains(@class, 'a-size-small a-color-secondary')]"], parsers, doc);
