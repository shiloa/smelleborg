    ...
    "func://amazon.com/cloudSearch2-showProductById2AdiTest": function(webcloudOutput) {
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        var output = {
          ...
          "creativeWork_author": getNodeValue(["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-row a-spacing-micro a-color-secondary')]/span[contains(@class, 'a-size-small')]"], doc),
          "creativeWork_contentRating": getNodeValue(["//span[contains(@class, 'a-declarative')]/span[contains(@class, 'a-size-small')]", "//span[contains(@class, 'a-declarative')]/span[contains(@class, 'a-size-small')]"], doc),
          "creativeWork_datePublished": getNodeValue(["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-row a-spacing-none a-size-small')]", "//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-row a-spacing-none a-size-small')]"], doc),
          "creativeWork_description": getNodeValue(["//div[contains(@class, 'a-size-mini')]"], doc),
          "creativeWork_duration": getNodeValue(["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-row a-spacing-micro a-color-secondary')]/span[contains(@class, 'a-size-small')]", "//div[contains(@class, 'a-size-mini')]"], doc),
          ...
          "creativeWork_qxyInfo": getNodeValue(["//span[contains(@class, 'a-text-bold')]"], doc),
          "creativeWork_qxyMoreInfo": parsers["creativeWork_qxyMoreInfo"](getNodeValue(["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-section a-spacing-micro')]/div[contains(@class, 'a-row a-size-small a-color-secondary')]"], doc)) ,
