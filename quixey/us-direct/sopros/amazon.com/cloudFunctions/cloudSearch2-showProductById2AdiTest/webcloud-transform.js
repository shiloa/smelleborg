var transform = function(webcloudOutput) {
  var transform = {
    "func://amazon.com/cloudSearch2-showProductById2AdiTest": function(webcloudOutput) {
      ...
      var parsers = {
          "creativeWork_author": function(str) {
            try {
              return 'gogo';
            } catch(e) {}
            return str;
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        var output = {
          "displayContent": {          
          "areaServed": getNodeValue(["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-section a-spacing-micro')]/div[contains(@class, 'a-row a-size-small a-color-secondary')]"], doc),
          ...
          "creativeWork_author": parsers["creativeWork_author"](getNodeValue(["//h5[contains(@class, 'a-size-base')]"], doc)) ,
          "creativeWork_datePublished": getNodeValue(["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-row a-spacing-micro a-color-secondary')]/span[contains(@class, 'a-size-small')]", "//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-row a-spacing-micro a-color-secondary')]/span[contains(@class, 'a-size-small')]"], doc),
