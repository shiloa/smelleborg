  ...
  var transform = {
    "func://amazon.com/cloudSearch2-showProductById2AdiTest": function(webcloudOutput) {
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        var output = {
          "displayContent": {          
          "description": getNodeValue(["//div[contains(@class, 'sx-table-detail')]/div[contains(@class, 'a-row a-spacing-micro a-color-secondary')]/span[contains(@class, 'a-size-small')]"], doc),
          ...
          "product_qxyPriceText": parsers["product_qxyPriceText"](getNodeValue(["//span[contains(@class, 'a-color-price')]"], doc)) ,
