    ...
    "func://askme.com/cloudSearch2-showProductById2": function(webcloudOutput) {
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        var output = {
          ...
          "product_price": parsers["product_price"](getNodeValue(["//span[contains(@class, 'deal_price')]"], doc)) ,
          "product_priceCurrency": parsers["product_priceCurrency"](getNodeValue(["//span[contains(@class, 'deal_price')]"], doc)) ,
