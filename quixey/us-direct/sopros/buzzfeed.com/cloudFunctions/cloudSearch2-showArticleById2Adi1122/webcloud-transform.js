...
return {
  "articleUrl": articleUrl
      ...
      for (var i = 0; i < cloudOutput.length ; i++) {
        ...
        addComputedValue(output.displayContent, "action_name", ["//div[contains(@class, 'byline__title')]"], parsers, doc);
        ...
        addComputedValue(output.displayContent, "name", ["//a[contains(@class, 'byline__author')]"], parsers, doc);
