...
return {
  "articleUrl": articleUrl
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        addComputedValue(output.displayContent, "photograph_description", ["//span[contains(@class, 'buzz-datetime')]"], parsers, doc);
        ...
        addComputedValue(output.displayContent, "photograph_qxyInfo", ["//div[contains(@class, 'byline__title')]"], parsers, doc);
