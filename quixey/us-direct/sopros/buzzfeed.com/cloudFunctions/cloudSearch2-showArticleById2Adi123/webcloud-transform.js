...
return {
  "articleUrl": articleUrl
      ...
      for (var i = 0; i < webcloudOutput.length ; i++) {
        ...
        addComputedValue(output.displayContent, "image", ["//div[contains(@class, 'buzz_superlist_item_text')]/div[contains(@class, 'buzz_superlist_item buzz-superlist-itembuzz_superlist_item_image longform_insert ')]/div[contains(@class, 'sub_buzz_content sub-buzz-content ')]/div[contains(@class, 'sub_buzz_media sub-buzz-mediajs-subbuzz__share-container ')]/a/img"], parsers, doc);
