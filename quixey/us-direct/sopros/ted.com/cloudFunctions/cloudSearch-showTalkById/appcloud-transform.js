  ...
  var transform = {
    "func://ted.com/cloudSearch-showTalkById": function(cloudOutput) {
      ...
      for (var i = 0; i < cloudOutput.length ; i++) {
        ...
        addComputedValue(output.displayContent, "doorTime", ["//span[contains(@class, 'android.widget.CheckedTextView')]"], parsers, doc);
        ...
        addComputedValue(output.displayContent, "startDate", ["//span[contains(@class, 'android.widget.CheckedTextView')]"], parsers, doc);
