var transform = function(cloudOutput, ttl) {
  var transform = {
    "func://ted.com/cloudSearch-showTalkById": function(cloudOutput) {
      ...
      var parsers = {          "description": function(str) {
            try {
              return 'bobo';
            } catch(e) {}
            return str;
      ...
      for (var i = 0; i < cloudOutput.length ; i++) {
        ...
        addComputedValue(output.displayContent, "description", ["//span[contains(@class, 'android.widget.CheckedTextView')]"], parsers, doc);
        addComputedValue(output.displayContent, "geo", ["//span[contains(@class, 'android.widget.CheckedTextView')]"], parsers, doc);
        ...
        addComputedValue(output.displayContent, "telephone", [], parsers, doc);
